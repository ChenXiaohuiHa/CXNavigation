//
//  CXImageMoveTwoViewController.m
//  CXNavigation
//
...
@interface CXImageMoveTwoViewController ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation CXImageMoveTwoViewController{
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"导航图片变换(二)";
